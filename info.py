...
API_ID = int(environ.get('API_ID', '22020362'))
API_HASH = environ.get('API_HASH', '8391f2f86c6f4f0a4b6f39dca3330479')
BOT_TOKEN = environ.get('BOT_TOKEN', '6451031569:AAE-nV2ZSa-HHUt5VTJOIhtdMCd3RjfKV1c')
...
PICS = (environ.get('PICS', 'https://telegra.ph/file/4ebaf45f07b0b5b603cc3.jpg')).split()

# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '5311466386').split()]
...
# Channels
INDEX_CHANNELS = [int(index_channels) if id_pattern.search(index_channels) else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001905671291').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001674156262')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001805029762'))

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://WARMACHINE2:WARMACHINE2@cluster0.jnrkvk7.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Files')

# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/AZ_Supports')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https:/t.me/AZ_Botz')
