...
async def pm_search(client, message):
    ...
    if IS_PM_SEARCH:
        ...
        if int(total) != 0:
            ...
            await message.reply_text(f'<b><i>🤗 ᴛᴏᴛᴀʟ <code>{total}</code> ʀᴇꜱᴜʟᴛꜱ ꜰᴏᴜɴᴅ ɪɴ ᴛʜɪꜱ ɢʀᴏᴜᴘ 👇</i></b>', reply_markup=InlineKeyboardMarkup(btn))
